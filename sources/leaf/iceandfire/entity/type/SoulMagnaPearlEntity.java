...
public class SoulMagnaPearlEntity extends class_3857 {
    private final List<class_2338> lavaPositions;
    private static final int LAVA_DURATION = 100;
    private int age;
    private boolean isDropped;

    public SoulMagnaPearlEntity(class_1299<? extends SoulMagnaPearlEntity> entityType, class_1937 world) {
    ...
    public SoulMagnaPearlEntity(class_1937 world, class_1309 owner) {
    ...
    protected class_1792 method_16942() {
        return ModItems.SOUL_MAGMA_PEARL;
    }
    ...
    private void createLava(class_2338 pos) {
        ...
        method_37908().method_8501(pos, ModBlocks.SOUL_LAVA.method_9564());
    ...
    private void removeLava() {
        for (class_2338 pos : this.lavaPositions) {
            ...
            if (blockState.method_26204() == ModBlocks.SOUL_LAVA && (blockState.method_26204() instanceof class_2404)) {
